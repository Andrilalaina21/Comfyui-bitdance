...
from .sampling_x import euler, euler_maruyama
...
BITDANCE_ATTENTION_MODE = "auto"


def set_bitdance_attention_mode(mode: str = "auto"):
    global BITDANCE_ATTENTION_MODE
    BITDANCE_ATTENTION_MODE = str(mode or "auto")
...
class Attention(nn.Module):
    ...
    def forward(
        ...
        attn_mode = BITDANCE_ATTENTION_MODE
        use_flash = (
            attn_mode in ("auto", "flash_attn_2", "flash_attn_3")
            and seqlen > 32
